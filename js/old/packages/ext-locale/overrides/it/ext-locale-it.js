...
Ext.define("Ext.locale.it.picker.Date", {
    ...
    todayText: "Oggi",
    minText: "Data precedente alla inc minima",
    maxText: "Data successiva alla inc massima",
    disabledDaysText: "",
    disabledDatesText: "",
...
Ext.define("Ext.locale.it.form.field.Date", {
    ...
    minText: "La inc deve essere maggiore o uguale a {0}",
    maxText: "La inc deve essere minore o uguale a {0}",
    invalidText: "{0} non \u00E8 una inc valida. Deve essere nel formato {1}",
    format: "d/m/Y",
