...
Ext.define("Ext.locale.lt.picker.Date", {
    ...
    todayText: "Šiandien",
    minText: "Ši inc yra mažesnė už leistiną",
    maxText: "Ši inc yra didesnė už leistiną",
    disabledDaysText: "",
    disabledDatesText: "",
...
Ext.define("Ext.locale.lt.form.field.Date", {
    ...
    minText: "Šiame lauke inc turi būti didesnė už {0}",
    maxText: "Šiame lauke inc turi būti mažesnėė už {0}",
    invalidText: "{0} yra neteisinga inc - ji turi būti įvesta formatu {1}",
    format: "y-m-d",
