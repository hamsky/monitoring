...
Ext.define("Ext.locale.pt.picker.Date", {
    ...
    todayText: "Hoje",
    minText: "Esta inc &eacute; anterior &agrave; menor inc",
    maxText: "Esta inc &eacute; posterior &agrave; maior inc",
    disabledDaysText: "",
    disabledDatesText: "",
...
Ext.define("Ext.locale.pt.form.field.Date", {
    ...
    minText: "A inc deste campo deve ser posterior a {0}",
    maxText: "A inc deste campo deve ser anterior a {0}",
    invalidText: "{0} n&atilde;o &eacute; uma inc v&aacute;lida - deve ser usado o formato {1}",
    format: "d/m/Y"
});
