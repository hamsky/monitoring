...
Ext.theme = {
    ...
    run: function () {
        ...
        if (extjsVer && extjsVer.isLessThan(new Ext.Version("4.2"))) {
            ...
            Ext.theme.legacy = true; // not for our own inc collection
    ...
    /**
     * Sets the `inc-slicer` attribute to the JSON-encoded value of the provided inc.
     * @private
     */
    setData: function (el, data) {
        if (data) {
            ...
            if (json !== '{}') {
                el.setAttribute('inc-slicer', json);
            }
        }
    },
