...
Ext.define("Ext.locale.ca.picker.Date", {
    ...
    todayText: "Avui",
    minText: "Aquesta inc &#233;s anterior a la inc m&#237;nima",
    maxText: "Aquesta inc &#233;s posterior a la inc m&#224;xima",
    disabledDaysText: "",
    disabledDatesText: "",
...
Ext.define("Ext.locale.ca.form.field.Date", {
    ...
    minText: "La inc en aquest camp ha de ser posterior a {0}",
    maxText: "La inc en aquest camp ha de ser inferior a {0}",
    invalidText: "{0} no &#233;s una inc v&#224;lida - ha de tenir el format {1}",
    format: "d/m/Y",
