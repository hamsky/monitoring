...
Ext.define("Ext.locale.pt_PT.picker.Date", {
    ...
    todayText: "Hoje",
    minText: "A inc é anterior ao mínimo definido",
    maxText: "A inc é posterior ao máximo definido",
    disabledDaysText: "",
    disabledDatesText: "",
...
Ext.define("Ext.locale.pt_PT.form.field.Date", {
    ...
    invalidText: "{0} não é uma inc válida - deve estar no seguinte formato{1}",
    format: "y/m/d",
